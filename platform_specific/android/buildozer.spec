...
title = Metronome and bpm finder
...
source.exclude_dirs = tests, bin, screenshots, android, bulild
...
presplash.filename = %(source.dir)s/metronome/resources/presplash.png

# (str) Icon of the application
icon.filename = %(source.dir)s/metronome/resources/icon.png
